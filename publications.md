...
***Choi~T.***, D.~Guevara, G.~Bandodkar, Z.~Cheng, C.~Wang, B.~N.~Bailey, M.~Earles, and X.~Liu:
[*DAVIS-Ag: A Synthetic Plant Dataset for Developing Domain-Inspired Active Vision in Agricultural Robots.*](https://arxiv.org/abs/2303.05764){:target="_blank"} Tol: 2023 IEEE International Conference on
Intelligent Robots and Systems (IROS 2023). Detroit, USA.

***Choi~T.***, Y.~Liu, and X.~Liu.
*Towards Fully Automated Decision-Making Systems for Smart Farming: Challenges, Opportunities, and  a Case Study.*
